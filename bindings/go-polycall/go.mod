...
require (
	github.com/stretchr/testify v1.8.4 // Unit testing framework
...
require (
	golang.org/x/net v0.19.0 // HTTP/2 and networking primitives
	golang.org/x/crypto v0.17.0 // Cryptographic validation for zero-trust
	golang.org/x/sys v0.15.0 // System-level operations
)
